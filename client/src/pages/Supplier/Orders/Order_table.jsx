...
const columns = [
  ...
  const rows = [
    { id: 1, Organization: 'Snow', IssueDate: '2022-05-01', Items:["Cement "," Sand "," Chips "], Due_date: '2022-05-06', Description: 'We want Ultra Cement'},
    { id: 2, Organization: 'Lannister',IssueDate: '2022-05-01',Items:["Cement "," Sand ","Chips "], Due_date: '2022-09-15', Description: 'We want Sanstha Cement' },
    { id: 3, Organization: 'Lannister',IssueDate: '2022-05-01',Items:["Cement "," Sand "], Due_date: '2022-09-16', Description: '-' },
    { id: 4, Organization: 'Stark',IssueDate: '2022-05-01',Items:["1 ft Pipe "," 3/4' Pipe"], Due_date: '2022-09-17', Description: 'We want Lanka Tiles' },
    { id: 5, Organization: 'Targaryen',IssueDate: '2022-05-01',Items:["1 ft Pipe "," 1/2' Pipe"], Due_date: '2022-09-18', Description: 'We want S-lone Pipes' },
