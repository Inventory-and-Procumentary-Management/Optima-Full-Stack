    ...
    <main className="m-5 p-5 md:max-w-xl md:mx-auto lg:max-w-2xl xl:max-w-4xl bg-white rounded shadow">
     ...
     <button
        ...
        hover:bg-transparent hover:text-blue-500 transition-all duration-300">Edit Information</button>
             ...
             <>
             <h2 className='main-topic-invoice'>Create Invoice</h2>
             <div className='maindiv-form-invoice'>
              <div className='subdiv-form-invoice'>
            ...
            <article className="main-input-part">
            <div className="flex flex-col">
            <label htmlFor="invoiceNum">Enter the Invoice Number</label><br></br>
             <input 
              type="text"
              name="invoiceNum"
              id="invoiceNum"
            ...
            <div className="flex flex-col">
              <label htmlFor="invoiceDate">Enter the Invoice Date</label><br></br>
             <input 
              type="date"
              name="invoiceDate"
              id="invoiceNum"
        ...
        <label htmlFor="notes">Additional Notes</label><br></br>
              <textarea name="notes" id="notes" cols="100" rows="5" placeholder="Additional notes to the client"
