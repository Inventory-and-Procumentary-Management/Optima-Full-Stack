  ...
  const setPricePerOne = (id) => {
    ...
    Swal.fire({
      ...
      preConfirm: (Price_per_one,isApprove) => {
        ...
        if(Price_per_one > 0 ){
          return updateSupplierProduct(id, { price: Price_per_one , isApprove:1 }, dispatch);
        }else{
          return false;
        }
  ...
  const setQuantity = (id) => {
    ...
    Swal.fire({
      ...
      preConfirm: (quantity,isApprove) => {
        //console.log(Price_per_one);
        if(quantity>0){
          return updateSupplierProduct(id, { availableQuantity: quantity , isApprove:1 }, dispatch);
        }else{
          return false;
        }
    ...
    Swal.fire({
      ...
      preConfirm: (description,isApprove) => {
        //console.log(Price_per_one);
          ...
          return updateSupplierProduct(id, { description: description , isApprove:1 }, dispatch);
